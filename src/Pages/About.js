...
const About = () => {
  return(
    <div>
      ...
      <a style={{textDecoration: 'none'}} href='https://github.com/Michaelreforged'>GitHub <External/></a>
      <br/>
      <a style={{textDecoration: 'none'}} href='https://www.linkedin.com/in/michael-cheung-dev/'>LinkedIn <External/></a>
    </div>
  )
};
